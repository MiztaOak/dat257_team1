...
/**
 * This class is related to the login View that is responsible for
 * authenticating the user's data from the database.
 *
 * @author : Oussama Anadani
 */
public class LoginUserView extends AppCompatActivity {
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {  // Sign in success, update UI with the signed-in user's information
                            Toast.makeText(LoginUserView.this, "Logged in successfully! ", Toast.LENGTH_SHORT).show();
                            FirebaseUser user = mAuth.getCurrentUser();
                            retrieveData(user);
                            //take the user to the main page after successfully retrieving the data
                            startActivity(new Intent(getApplicationContext(), MainActivity.class));
                        } else { // If sign in fails, display a message to the user.
                            Toast.makeText(LoginUserView.this, "Login failed! ", Toast.LENGTH_SHORT).show();
                            //   retrieveData(null);
                        }
